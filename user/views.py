...
from user.form import UserLoginForm, UserProfileForm, UserRegistrationForm
...
class UserRegistrationView(TitleMixin, SuccessMessageMixin, CreateView):
    ...
    success_message = 'Вы успешно зарегистрировались! Для подтверждения почты перейдите по ссылке, ' \
                      'высланной на указанный почтовый адрес'
